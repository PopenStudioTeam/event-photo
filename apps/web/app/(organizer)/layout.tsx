...
export default function AdminLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="organizer-shell min-h-screen bg-[radial-gradient(ellipse_at_top,_#E4D4FF_0%,_var(--background)_55%)] dark:bg-[radial-gradient(ellipse_at_top,_#3B1D6E_0%,_var(--background)_55%)]">
      <Sidebar />
