...
export default function AdminLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="organizer-shell min-h-screen bg-[radial-gradient(ellipse_at_top,_#DCCEF0_0%,_var(--background)_55%)] dark:bg-[radial-gradient(ellipse_at_top,_#1e293b_0%,_var(--background)_50%)]">
      <Sidebar />
